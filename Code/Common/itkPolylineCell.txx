...
=========================================================================*/
#ifndef _itkPolylineCell_txx
#define _itkPolylineCell_txx
...
::BuildEdges(void)
{
  if( m_PointIds.size() > 0 )
    {
    m_Edges.resize(m_PointIds.size()-1); //added -1
    ...
    //no edge is needed to be established between the last point and the first
